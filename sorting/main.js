...
function addElement(value, height, index) {
    ...
    // if ( index == 7 ) {
    //     newDiv.setAttribute("class", "element coloris")
    //     newDiv.setAttribute("coloris-value", "rgb(255, 0, 0)")
...
/////////////////////////////////////////////////////
// var colorVisibility = document.getElementById('color-picker');
// // colorVisibility.style.opacity
...
// var colorLabel = document.getElementsByClassName('color-label')[0];
